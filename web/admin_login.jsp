...
<!--主要样式-->
<link type="text/css" href="${pageContext.request.contextPath}/assets/css/style2.css" rel="stylesheet" />
...
<style>
    body{
        background: url(assets/css/banner.jpg);
...
<div class="container" align="center">
    <div class="col-md-6" style="margin-top: 8%;">
        <div class="inset">
            <form name="login" id="login" method="post" action="${pageContext.request.contextPath}/user/adminLogin.do" onSubmit="return CheckLogin(document.login);">
                <input type="hidden" name="enews" value="login">
                <div>
                    <h2>VideoShare后台管理</h2>
