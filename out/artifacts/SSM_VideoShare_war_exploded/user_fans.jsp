...
<div class="main_content">
            ...
            <div class="nav-channal" k-sticky="offset:61;media : @s">
                <nav class="responsive-tab">
                    <ul>
                        ...
                        <li class="uk-active"><a  class="active" href="${pageContext.request.contextPath}/user/disRelationUserFById.do?user_id=${user1.id}">Fans</a></li>
    ...
    <h3 style="margin: 15px;"> Your Fans </h3>

    <div class="uk-child-width-1-4@m uk-child-width-1-2@s" uk-grid>
        <c:forEach items="${relationUserF}" var="all">
            <div>
                <a href="${pageContext.request.contextPath}/video/DisOtherUserById.do?user_id=${all.user_item.user_id}&page=1">
                    <div class="channal-card animate-this">
                        ...
                        <div class="channal-card-body">
                            ...
                            <h4>${all.user_item.username} ${all.user_item.user_id}</h4>
        ...
        <c:if test="${user1_item.getFans()==0}"><h3>你还没有粉丝喔，别气馁！多分享一些精彩视频吧。</h3></c:if>
    </div>
